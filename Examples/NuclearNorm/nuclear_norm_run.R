...
time_pxm <- system.time(result_pxm <- px.mala(y=y, alpha = alpha_hat, lambda = lamb_coeff, 
             sigma2 = sigma2_hat, iter = iter, delta = step_pxmala, start = warmup_end_iter))
...
time_ism <- system.time(result_ism <- mymala(y=y, alpha = alpha_hat, lambda = lamb_coeff, 
             sigma2 = sigma2_hat, iter = iter, delta = step_ismala, start = warmup_end_iter))
...
#              sigma2 = sigma2_hat, iter = iter, delta = step_pxb, start = warmup_end_iter))
...
#               sigma2 = sigma2_hat, iter = iter, delta = step_isb, start = warmup_end_iter))
...
time_pxh <- system.time(result_pxhmc <- pxhmc(y=y, alpha = alpha_hat, lambda = lamb_coeff,
          sigma2 = sigma2_hat, iter = iter, eps_hmc = eps_px, L=L, start = warmup_end_iter))
...
time_ish <- system.time(result_ishmc <- myhmc(y=y, alpha = alpha_hat,lambda = lamb_coeff, 
           sigma2 = sigma2_hat, iter = iter, eps_hmc = eps_is, L=L, start = warmup_end_iter))
