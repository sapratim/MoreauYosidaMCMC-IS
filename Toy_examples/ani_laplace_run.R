...
###  For saving necessary data viz. marginal variances and rel eff
...
rel_eff_20 <- matrix(0, nrow = reps, ncol = 5)
...
output_laplace <- foreach(i = 1:reps) %dopar% {
  ...
  ess_ism_5[i] <- (mean(wts)^2)/mean(wts^2)
...
output_d5 <- list(asymp_margvar_is5, asymp_margvar_pilam_d5, rel_eff_5, ess_ism_d5)
output_d10 <- list(asymp_margvar_is10, asymp_margvar_pilam_d10, rel_eff_10, ess_ism_d10)
output_d20 <- list(asymp_margvar_is20, asymp_margvar_pilam_d20, rel_eff_20, ess_ism_d20)
output_d50 <- list(asymp_margvar_is50, asymp_margvar_pilam_d50, rel_eff_50, ess_ism_d50)

save(output_d5, file = "output_d5.Rdata")
save(output_d10, file = "output_d10.Rdata")
save(output_d20, file = "output_d20.Rdata")
save(output_d50, file = "output_d50.Rdata")
